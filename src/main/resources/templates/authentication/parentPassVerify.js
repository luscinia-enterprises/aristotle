...
const password = document.getElementById('new-parent-password')
const pwConfirm = document.getElementById('confirm-new-parent-password')
const passphrase = document.getElementById('passphrase')
const errorElement = document.getElementById('parent-error')
